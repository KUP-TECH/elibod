                ...
                <div class="px-4 pt-4 pb-3">
                    ...
                    <form action="{{ route('login_post') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="Email" id="emailInput" oninput="checkEmail()">
                        ...
                        <div class="text-center">
                            <h6>Don't have an account? <a href="{{ route('register') }}" class="register-link">Register</a></h6>
                        </div>
